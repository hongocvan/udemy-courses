...
/*
User story -> Features -> Flowchart -> Architecture -> Implementation
*/
...
const run1 = new Running([123, -12], 5.2, 24, 178);
const cycling1 = new Cycling([123, -12], 27, 41, 145);
...
class App {
    ...
    _loadMap(position) {
        ...
        console.log(
            `https://www.google.com/maps/@${latitude},${longitude},11z?hl=vi-VN`
        );
